...
(
  ...
  assign addr_config_reg_we_o        = (deassert_we_i) ? 1'b0          : addr_config_reg_we;
  assign cood_reg_we_o               = (deassert_we_i) ? 1'b0          : cood_reg_we;
